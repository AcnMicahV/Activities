		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Routing and Navigation Activity",
									"targetURL": "#zbtpday5activityroutingmicah-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5activityroutingmicah-display": {
								"semanticObject": "zbtpday5activityroutingmicah",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5activityroutingmicah",
									"url": sap.ui.require.toUrl("zbtp/day5activityroutingmicah")
								}
							}
						}
					}
