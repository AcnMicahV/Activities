		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mock Server",
									"targetURL": "#sapipstrainingmockserver-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingmockserver-display": {
								"semanticObject": "sapipstrainingmockserver",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.mockserver",
									"url": sap.ui.require.toUrl("sapips/training/mockserver")
								}
							}
						}
					}
